...
sejam distinguidos, garantindo a integridade dos pacotes recebidos.
...
de forma a evitar retransmissões desnecessárias.

\textcolor{red}{NOTA TODO ainda só fazemos esta deteção para pacotes fragmentados!}
...
\texttt{INITIAL\_WINDOW\_SIZE}, sendo este valor de 32 pacotes. O emissor, ao enviar um pacote, ...

\textcolor{red}{
    TODO: neste momento usamos o window size no array de pacotes a ordenar/desfragmentar,
    não deverá ser nos pacotes por receber acks? ou ambos?
}
...
\subsection{\textit{nms\_server.py}}
